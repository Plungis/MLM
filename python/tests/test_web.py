...
def test_dashboard_and_health_on_fresh_database(tmp_path: Path) -> None:
    ...
    assert 'src="/static/absidekick.js?v=0.5.0b49"' in absidekick.text
    assert 'href="/static/absidekick.css?v=0.5.0b49"' in absidekick.text
    ...
    assert "0.5.0b49" in spender_config.text
